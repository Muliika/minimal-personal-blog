    ...
    <div className="max-w-3xl mx-auto p-5 mb-16">
        ...
        <div className="">
            <div className="py-16 px-4 text-center sm:px-6 lg:px-8">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900">All blog posts</h1>
            ...
            <section aria-labelledby="filter-heading" className="grid items-center border-t">
                ...
                <div className="relative col-start-1 row-start-1 py-4">
                    <div className="mx-auto flex space-x-6 divide-x divide-gray-200 px-4 text-sm sm:px-6 lg:px-8">
                        <div>
                        <button type="button" className="group flex items-center font-medium text-gray-700" aria-controls="disclosure-1" aria-expanded="false" onClick={()=>setFilter(!filter)}>
                ...
                <div className="mx-auto flex max-w-7xl justify-end px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex">
                        <button type="button" className="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900" id="menu-button" aria-expanded="false" aria-haspopup="true" onClick={()=>setSort(!sort)}>
                        Sort
