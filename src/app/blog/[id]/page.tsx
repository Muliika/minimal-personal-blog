        ...
        <div className="relative overflow-hidden py-16">
            ...
            <div className="relative px-6 lg:px-8">
                ...
                <h1>
                    ...
                    <span className="mt-2 block text-center text-3xl font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl">Odio penatibus risus viverra tellus varius sit neque erat velit.</span>
                </h1>
        ...
        <div className="max-w-3xl mx-auto px-5 mb-20">
            ...
            <div className="flex">
                ...
                <div>
                    ...
                    <div className="mr-4 flex-shrink-0">
                        <svg className="h-12 w-12 border border-gray-300 bg-white text-gray-300" preserveAspectRatio="none" stroke="currentColor" fill="none" viewBox="0 0 200 200" aria-hidden="true">
                        <path vector-effect="non-scaling-stroke" stroke-width="1" d="M0 0l200 200M0 200L200 0" />
                        </svg>
                    </div>
                    <div>
